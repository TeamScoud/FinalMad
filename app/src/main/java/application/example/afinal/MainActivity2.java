        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (deleteRows > 0){
                    ...
                    Toast.makeText(MainActivity2.this, edtSubject.getText().toString() + " Deleted Successfully", Toast.LENGTH_SHORT).show();

                }else{

                    Toast.makeText(MainActivity2.this, edtSubject.getText().toString() + " Deleted Not Successfully", Toast.LENGTH_SHORT).show();
